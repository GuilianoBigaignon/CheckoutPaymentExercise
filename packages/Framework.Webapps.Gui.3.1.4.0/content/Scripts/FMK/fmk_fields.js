    ...
    $.widget('fmkTranslatableAreaField', {
        _init: function () {
            ...
            $.getJSON(url).done(function (res) {
                ...
                this.options.selector = this.addSelector(htmlList, languages);
        ...
        addSelector: function (htmlList, languages) {
...
(function ($, tplEngine) {
    ...
    $.widget('fmkCheckboxField', {
        ...
        buildRemote: function () {
            this.loading = true;
            var url = tplEngine.render(this.options.fieldDesc.remote.href, this.dependencies || {});
            ...
            var source =
                {
                    ...
                    url: tplEngine.render(this.options.fieldDesc.remote.href, this.dependencies || {})
                };
...
(function ($) {
    ...
    $.fn.validateFmkField = function (ruleName) {
        return $(this).getFmkWidget().validate(ruleName);
    };
